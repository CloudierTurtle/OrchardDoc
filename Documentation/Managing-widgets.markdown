...
contenttype("Page")          | True if the Content Type being displayed matches the one specified within the rule
not                          | Logical NOT.
and                          | Logical AND.
or                           | Logical OR.
...
* Updates for Orchard 1.7
    * 3-31-14: Updated rule syntax to include Content Type rule
